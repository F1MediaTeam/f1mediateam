  ...
  return (
    <AdminShell session={session} active="/admin/clients">
      ...
      <div className="px-8 py-8 max-w-[1600px]">
        ...
        <div className="mb-8">
          {/* Combined GSC chart (clicks + impressions + avg position on one
              graph) — same view the client sees. */}
          ...
          <CardBody>
            {!semrushConnected ? (
              ...
              <>
                ...
                <SemrushInsights
                  data={buildSemrushChartData(semrushReports)}
                  keywordRows={organicKeywordsReport?.rows ?? []}
                  editable
                />
