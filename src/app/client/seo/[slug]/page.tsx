...
const SLUGS: Record<string, SlugMeta> = {
  ...
  // The four gauges below are point-in-time readings (tracked under snapshot
  // source "manual", refreshed from the SEMrush UI) — average them per bucket,
  // never sum.
  "site-health": {
    label: "Site Health",
    source: "available",
    ...
    aggregation: "average",
    unit: "%",
    provider: "SEMrush Site Audit",
    hint: "Overall technical health score of the site — crawl errors, broken links, and on-page issues.",
  },
  "ai-visibility": {
    label: "AI Visibility",
    source: "available",
    ...
    unit: "%",
    provider: "SEMrush",
    hint: "How often the brand appears in AI search answers (ChatGPT, Gemini, AI Overviews).",
  },
  mentions: {
    label: "Mentions",
    source: "available",
    ...
    aggregation: "average",
    provider: "SEMrush",
    hint: "Brand mentions detected across the web.",
  },
  backlinks: {
    label: "Backlinks",
    source: "available",
    metric: "semrush_backlinks",
    aggregation: "average",
    provider: "SEMrush",
    hint: "Total links pointing to the site from other domains.",
  },
};
