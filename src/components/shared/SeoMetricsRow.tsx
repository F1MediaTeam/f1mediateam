...
const METRICS: MetricDef[] = [
  { slug: "ai-visibility", label: "AI Visibility", source: "ai_visibility",   unit: "%" },
  { slug: "mentions",      label: "Mentions",      source: "mentions" },
  { slug: "site-health",   label: "Site Health",   source: "site_health",     unit: "%" },
  ...
  { slug: "backlinks",        label: "Backlinks",        source: "semrush_backlinks" },
];
